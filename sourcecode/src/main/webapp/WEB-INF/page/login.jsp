...
<head>
    ...
    <title>Online Food Ordering Back-end Login</title>
...
<div class="lg">
    <form action="/login" method="POST">
        ...
        <div class="lg_main">
            <div class="lg_m_1">
                ${error}
                <input name="name" id="name" placeholder="Username" value="" class="ur" />
                <input name="password" id="password" placeholder="Password" type="password" value="" class="pw" />
