...
<article class="cl pd-20">
    <form action="/config/updateRole" method="post" class="form form-horizontal" id="form-admin-role-add" target="_parent">
        <div class="row cl">
            ...
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Role name：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${role.name}" placeholder="" id="roleName" name="name" datatype="*4-16" nullmsg="User account cannot be empty.">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">Role description：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${role.desc_}" placeholder="" id="" name="desc_">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">Role permission：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <button type="submit" class="btn btn-success radius" id="admin-role-save" name="admin-role-save"><i class="icon-ok"></i> Confirm</button>
            </div>
        </div>
    </form>
</article>
