                            ...
                            <div class="tab-pane fade show active"  role="tabpanel">
                                <div class="myaccount-content">
                                    ...
                                    <ul style="float:left" class="order_list_th">
                                        <li class="col01">${vs.count}&nbsp;&nbsp;&nbsp;&nbsp;Order number：${order.code},Paid for</li>
                                    </ul>
                                            ...
                                            <tr>
                                                <td width="55%">
                                                    ...
                                                    <ul class="order_goods_list">
                                                        ...
                                                        <li class="col04"><a href="javascript:;" onclick="pingjia(${oi.product.id});">Comment</a></li>
                                                    </ul>
                                                    </c:forEach>
                                                </td>
                                                <td width="15%">${order.total}Yuan</td>
                                                <td width="15%" >
                                                ...
                                                <td width="15%">
                                                    <c:if test="${order.status==1}">Not shipped</c:if>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contents" class="col-sm-4 control-label">User Comments</label>
                    <div class="col-sm-12">
