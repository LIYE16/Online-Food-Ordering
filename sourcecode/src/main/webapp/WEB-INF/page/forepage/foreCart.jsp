                    ...
                    <div class="col-lg-6 col-12 d-flex">
                        ...
                        <div class="cart-summary">
                            <div class="cart-summary-wrap">
                                ...
                                <p>Subtotal of quantity <span id="OisNum"></span></p>
                                <h2>Total (excluding freight) <span id="OisTotal"></span></h2>
                            </div>
                            <div class="cart-summary-button">
                                <button class="update-btn" onclick="subMyOrder();">Place an order</button>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function subMyOrder() {
        if(oiids.length==0){
            alert("Please check the goods you want to buy.");
            return false;
        }
        ...
        $.get(
            ...
            function (result) {
                if(result="success"){
                    ...
                    alert("Login expired, please log in.");
                }
            }
        );
    }
