                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    <p>Food on the tip of the tongue, in one step</p>
                                    <h1>Delicious food is irresistible</h1>
                                    <p>Now if you place an order of 299 yuan or more, you can get a discount of 30 yuan, a limited-time discount.</p>
                                    <a href="foreDetailUI?id=30" class="slider-btn">View details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <p>chocolate cake.</p>
                                    <a href="foreDetailUI?id=13" class="slider-btn">View details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-column justify-content-center align-items-start h-100">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    <p>Anniversary steak special offer</p>
                                    <h1>The ultimate food</h1>
                                    <p>Enjoy the new products and have a good taste.</p>
                                    <a href="foreDetailUI?id=31" class="slider-btn">View details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="slider-banner-sidebar-three-container">
                        <div class="sidebar-container">
                            ...
                            <!--=======  sidebar  =======-->
                            <div class="sidebar">Order food online to resist the cold winter and buy it quickly for a day.</div>
                            <!--=======  End of sidebar  =======-->
                        </div>
                        <!--=======  banner  =======-->
                                ...
                                <div class="fl-product">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="hover-icons">
                                            <ul>
                                                <li><a href="#"  data-tooltip="Buy now" id="nowPayment" onclick="buyNow(${product.id},${product.price});"><i class="icon ion-md-options"></i></a></li>
                                                <li>
                                                    <a href="#" data-toggle = "modal" data-target="#quick-view-modal-container" data-tooltip="Add to cart"
