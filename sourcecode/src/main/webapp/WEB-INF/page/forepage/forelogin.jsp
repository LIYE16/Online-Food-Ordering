                    ...
                    <div class="login-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12 mb-20">
                                ...
                                <input name="name" id="name" class="mb-0" type="name" placeholder="Please enter your username.">
                            </div>
                            <div class="col-12 mb-20">
                                <label>Password</label>
                                <input name="password" id="password" class="mb-0" type="password" placeholder="Please enter the password.">
                            </div>
    ...
    $(function () {
        ...
        $("form.loginForm").submit(function(){
            if(0==$("#name").val().length||0==$("#password").val().length){
                $("span.errorMessage").html("The account number or password cannot be empty.");
