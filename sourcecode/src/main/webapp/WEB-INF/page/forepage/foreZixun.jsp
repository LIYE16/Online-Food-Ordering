        ...
        <div class="row">
            ...
            <div class="col-lg-12 order-1">
                ...
                <div class="blog-single-post-container mb-30">
                    ...
                    <h3 class="post-title">University Info</h3>
                    ...
                    <div class="post-content mb-40">
                        ...
                        <blockquote>
                            <p>
                                Users can post their own questions, which will be displayed after the administrator approves it.
                                <button style="float:right" class="btn btn-default"><a href="javascript:;" onclick="fabuzixun();">Issue</a></button>
                            </p>
                ...
                <div class="comment-section mb-md-30 mb-sm-30">
                    ...
                    <div class="comment-container mb-40">
                        ...
                        <div class="single-comment">
                            ...
                            <div class="content">
                                <h3 class="user">${z.customer.name} <span class="comment-time"><fmt:formatDate value="${z.fabudate}" pattern="yyyy/MM/dd/HH:mm" /></span></h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contents" class="col-sm-4 control-label">Enter the information</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="button" class="btn btn-default"  id="modalFabu">Issue</button>
                    </div>
                </div>
                <%--</form>--%>
            </div>
    ...
    $(function () {
        $("#modalFabu").click(function () {
            ...
            $.get(
                ...
                function (result) {
                    if(result=="success"){
                        alert("It has been submitted, please wait for the administrator to review.");
                        $('#myModal').modal('hide');
                    }
                }
            );
