                ...
                <form action="#">
                    ...
                    <div class="cart-table table-responsive mb-40">
                        <table class="table">
                            <thead>
                            <tr>
                                <th class="pro-thumbnail">Picture</th>
                                    ...
                                    <div class="row row-40">
                                        ...
                                        <div class="col-lg-12 mb-20">
                                            ...
                                            <div id="billing-form" class="mb-40">
                                                <h4 class="checkout-title">Fill in the receipt information</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-20">
                                                        <div class="check-box">
                                                            ...
                                                            <label for="create_account">Create a new account?</label>
                                                        </div>
                                                        <div class="check-box">
                                                            <input type="checkbox" id="shiping_address" data-shipping>
                                                            <label for="shiping_address">Shipping to different locations</label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-60">
                                                    ...
                                                    <h4 class="checkout-title">Shopping cart information</h4>

                                                    <div class="checkout-cart-total">
                                                        <p>Quantity <span>${number}</span></p>
                                                        <p>Total <span>$${total}</span></p>

                                                        <p>Freight <span>￥10.00</span></p>

                                                        <h4>Total <span>$${total+10}</span></h4>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="checkout-payment-method">
                                                        ...
                                                        <div class="single-method">
                                                            ...
                                                            <p data-method="check">Please send the check store name in the shopping street, store town, store status, store zip code, store country/region.</p>
                                                        </div>

                                                        <div class="single-method">
                                                            <input type="radio" id="payment_bank" onclick="payedFunc(this);" name="payment-method" value="bank">
                                                            <label for="payment_bank">Direct bank transfer</label>
                                                            <p data-method="bank">Please fill in the bank card account number.</p>
                                                        </div>

                                                        <div class="single-method">
                                                            <input type="radio" id="payment_cash" onclick="payedFunc(this);" name="payment-method" value="cash">
                                                            <label for="payment_cash">Cash on delivery</label>
                                                            <p data-method="cash">The order is ready for immediate delivery.</p>
                                                        </div>

                                                        <div class="single-method">
                                                            <input type="radio" id="payment_paypal" onclick="payedFunc(this);" name="payment-method" value="paypal">
                                                            <label for="payment_paypal">Alipay</label>
                                                            <p data-method="paypal">Scan Alipay QR code to pay</p>
                                                        </div>

                                                        <div class="single-method">
                                                            <input type="radio" id="payment_payoneer" onclick="payedFunc(this);" name="payment-method" value="payoneer">
                                                            <label for="payment_payoneer">WeChatPay</label>
                                                            <p data-method="payoneer">Scan WeChat QR code to pay</p>
                                                        </div>

                                                        <div class="single-method">
                                                            <input type="checkbox" id="accept_terms" onclick="yuedu(this)">
                                                            <label for="accept_terms">I have read and accepted the terms and conditions.</label>
                                                        </div>

                                                    </div>

                                                    <button class="place-order">
                                                        <a href="javascript:;" id="order_btn" onclick="createOrder();">Submit an order</a>
                                                    </button>
...
<script type="text/javascript">
    ...
    function createOrder() {
        ...
        if(name==""||email==""||address==""||phone==""){
            alert("The receiving information cannot be empty!");
            return;
        }
        if(!readed){
            alert("Please click I have read and accepted the terms and conditions.");
            return;
        }
        if(!payedFun){
        ...
        var cstAddress = "Name："+name+",Email："+email+",Delivery address："+address+",Phone："+phone;
