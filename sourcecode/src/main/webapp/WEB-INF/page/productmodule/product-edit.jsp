...
<article class="cl pd-20">
    <form action="/product/updateProduct" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-admin-add"  target="_parent">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Product name：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${product.name}" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Product price：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.price}" placeholder="" id="price" name="price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Popularity：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="${product.zan}" placeholder="" id="zan" name="zan">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Sales volume：</label>
            <div class="formControls col-xs-8 col-sm-9">
       ...
       <div class="row cl">
           ...
           <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>Product picture：</label>
           <div class="formControls col-xs-8 col-sm-9">
              <img src="${pageContext.request.contextPath}/${product.imageurl}" width="100px" height="50px">
           </div>

           <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>Upload picture：</label>
           <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">Category：</label>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">Seller：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
